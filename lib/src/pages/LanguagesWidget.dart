          ...
          children: <Widget>[
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                SettingsRepository_.getDefaultLanguage(SettingsRepository_.setting.value.mobileLanguage.value.languageCode).then((_langCode) {
                ...
                return InkWell(
                  onTap: () async {
                    SettingsRepository_.setting.value.mobileLanguage.value = new Locale(_language.code, '');
                    ...
                    SettingsRepository_.setDefaultLanguage(_language.code);
                  },
                  child: Container(
